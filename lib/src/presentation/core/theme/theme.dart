...
extension BuildContextExtension on BuildContext {
  ...
  /// Gets the appropriate color extension.
  ///
  /// Returns [ColorExtension] for light themes.
  ///
  /// Throws if the color extension is not found.
