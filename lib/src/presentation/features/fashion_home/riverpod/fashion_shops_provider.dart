...
/// Fashion shops in the active franchise. `fashion` resolves against the
/// `ShopCategory` label/value server-side (same path Mart's `mart` uses).
final fashionShopsProvider = FutureProvider.autoDispose<List<ShopData>>((
  ref,
) async {
