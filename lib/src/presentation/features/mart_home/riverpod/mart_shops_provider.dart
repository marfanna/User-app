...
/// Mart shops in the active franchise. Unlike Medicine, the `mart` category
/// value is a fixed, unambiguous backend enum — no dynamic resolution needed.
final martShopsProvider = FutureProvider.autoDispose<List<ShopData>>((
  ref,
) async {
