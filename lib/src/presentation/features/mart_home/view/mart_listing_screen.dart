...
/// Cross-shop listing of Mart products in one category. Reached by tapping a
/// homepage category strip's "See all". Mirrors `MedicineListingScreen`.
class MartListingScreen extends ConsumerWidget {
  const MartListingScreen({super.key, required this.args});

  final MartListingArgs args;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final text = context.textStyle;
    final dims = context.dimensions;
    final async = ref.watch(martListingProvider(args.categoryLabel));
                ...
                child: async.when(
                  ...
                  data: (items) {
                    ...
                    return GridView.builder(
                      ...
                      itemBuilder: (_, i) =>
                          MartProductGridTile(item: items[i]),
                    );
                  },
                ),
              ),
